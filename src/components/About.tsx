...
const About = () => {
  ...
  return (
    <section id='about' className='px-4 py-24 bg-switch-background/20'>
        <div className='container grid grid-cols-1 lg:grid-cols-5 max-w-7xl gap-12'>
            <div className=' flex items-center lg:col-span-2 '>
                <div className='relative w-full'>
                    ...
                    <img src="images/statue.jpeg" alt=""  className='rounded-2xl w-full h-[500px] object-cover shadow-2xl relative'/>
                </div>
            </div>
