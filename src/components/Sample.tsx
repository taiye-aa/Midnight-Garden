...
const Sample = () => {
  return (
    <section id='sample' className='overflow-hidden flex justify-center items-center flex-col min-h-screen px-24 bg-[url("/images/pooh.jpeg")] bg-cover bg-center'>
        ...
        <div>
            <div className='max-w-4xl text:lg md:w-3xl lg:w-full md:text-xl text-white/90 leading-relaxed flex flex-col items-center bg-background/10 backdrop-blur-md border border-white/20 px-8 py-9 gap-4 rounded-2xl mt-8'>
